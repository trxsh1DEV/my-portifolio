...
export default function Home() {
  ...
  const skills = [
    { name: "Frontend", icon: <Layout size={32}/>, description: "React, TypeScript, TailwindCSS, NextJS, Redux, Sass, Zod, EJS, MUI, Style-component, React-query, Recharts" },
    { name: "Backend", icon: <Server size={32}/>, description: "Node.js, C#, Express, NestJS, Fastify, Jest, PostgreSQL, MySQL, MongoDB, Redis, Firebase" },
    { name: "Mobile", icon: <Smartphone size={32}/>, description: "React Native" },
    { name: "Other", icon: <Code2 size={32}/>, description: "Git, Docker, AWS/Azure, Nginx/Apache, Figma, Wordpress, Strapi, Vercel, Shell Script" },
  ];
  ...
  const projects = [
    {
      ...
      tech: ["C#", "TypeScript", "NestJS", "Fastify", "React", "Shadcn/ui", "TailwindCSS", "MongoDB", "Redis", "Docker", "Jotai"],
      link: "",
    ...
    },
    {
      ...
      description: "Full-featured e-commerce platform specialized in computer hardware sales, featuring real-time inventory management, secure payment processing, and comprehensive analytics dashboard for business insights.",
      tech: ["Express.js", "React", "TypeScript", "MUI", "Redux", "Stripe", "MongoDB", "React-Query", "Sass", "Recharts", "Firebase"],
      link: "",
      urlImage: "/dashboard-ecommerce.jpeg"
    },
    {
      title: "Personal Blog",
      description: "Modern, responsive blog platform built with NextJS and Strapi CMS. Features dynamic content loading, comment system integration, and optimized image delivery through Cloudinary.",
      tech: ["NextJS", "React", "TypeScript", "Styled-components", "Strapi", "Netlify", "MongoDB", "Disqus", "Cloudinary"],
      link: "",
      urlImage: "/content1-blog.png"
    },
    {
      title: "Stock Management System",
      description: "Inventory management solution designed for social projects, featuring real-time stock tracking, automated alerts for low inventory, and comprehensive reporting system.",
    ...
    },
    {
      ...
      description: "Educational website dedicated to supporting children with Autism Spectrum Disorder, providing resources, interactive content, and support information for families and caregivers.",
    ...
    <div className="max-w-[120rem] mx-auto">
      <section className="min-h-screen flex items-center justify-center">
        ...
        >
          ...
          <h3 className="text-2xl font-light mb-4 px-16">I am a Full-Stack Developer. I am Currently working at <NavLink target="_blank" to={"https://infonova.com.br"}>Infonova Tecnologia </NavLink> as a Full-Stack in several projects</h3>
          <Button asChild>
            <a 
              href="#contact" 
              onClick={(e) => {
      ...
      <section ref={ref} id="about" className="py-16">
        ...
        >
          <div className="space-y-4">
            ...
            I’m a 21-year-old Brazilian full-stack developer passionate about building complete applications from start to finish. Currently, I’m working on a project for IT asset inventory and management software. I enjoy diving into every stage of the development process, with a special interest in UX design and system integrations. My goal is to create efficient, intuitive, and with high availability solutions.
            </p>
          </div>
          <div className="aspect-square bg-transparent rounded-lg">
            <img src="https://aakash-sharma.netlify.app/static/media/webdev.4d72dbba32efee3890cef9bcacce7aa7.svg" alt="" />
          </div>
        </motion.div>
      </section>
        ...
        <div className="space-y-8">
          <div className="bg-card rounded-lg p-6">
            ...
            <div className="space-y-4 text-muted-foreground">
              <p>
                Currently working on multiple innovative projects focusing on IT infrastructure management and monitoring:
              </p>
              
              <ul className="list-disc pl-6 space-y-2">
                <li>
                  Developed integrations between ticketing system and internal dashboard platform, 
                  enabling comprehensive data analysis and reporting for tickets and device management.
                </li>
                
                <li>
                  Built an "IT Infrastructure Compliance" system that analyzes clients' IT infrastructure, 
                  generating automated feedback, insights, and reports highlighting IT maturity levels, 
                  potential improvements, security vulnerabilities and integration with SSO.
                </li>
